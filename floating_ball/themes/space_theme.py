"""Space theme - modern clock dial with radial light rays and dual dial visualization."""
import math
...
class SpaceTheme(BaseTheme):
    ...
    def _draw_clock_surface(self, painter, x_offset, size, data=None):
        ...
        # Draw 7-day arcs for 7-day ball (NEW FEATURE)
    ...
    def _draw_7day_arcs(self, painter, center_x, center_y, outer_ring_radius, time_percentage):
        ...
        for day in range(7):
            ...
            if day < current_day:
                ...
                # Draw the progress part with Glow and Gradient
                if day_progress > 0:
                ...
                # Future days included in "shallow" loop above
                pass
    ...
    def draw_ball(self, painter: QPainter, x_offset: int, data: BallData,
        ...
        if render_mode == 0:
            ...
            # Draw clock surface with radial rays (on top of space bg)
            # Pass data so it can draw 7-day arcs
